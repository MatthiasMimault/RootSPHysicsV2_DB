...
protected:
  ...
  int typeCase, typeGrowth, typeCompression, typeDivision, typeAni, typeDamping, typeCorrection;
  bool typeDev;
  float dampCoef, aM0, posGr, spGr, ctGr, po2Gr, s2Gr, c2Gr, klGr, 
	  aDv, bDv, pDv, posAn, spAn, cstAn;
  // Plan mirroir
  float PlanMirror;
  // Extension Domain
  float BordDomain;
