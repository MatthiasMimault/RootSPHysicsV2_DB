...
protected:
  ...
  tmatrix3f   *VSortMatrix3f;    ///<To order vectors tmatrix3f (write to VSort). /// Matthias
  bool		  *VSortBool;		 ///<To order vectors tmatrix3f (write to VSort). /// Matthias
...
public:
  ...
  // Matthias
  void SortArray(tmatrix3f *vec);
  void SortArray(bool *vec);
