...
public:
  ...
  /// Calls \ref GetAttributeDouble3() with the same parameters.
  //==============================================================================
  tsymatrix3f GetAttributeTsymatrix3F(TiXmlElement* ele, const char* name1 = "xx", const char* name2 = "xy", const char* name3 = "xz"
	  , const char* name4 = "yy", const char* name5 = "yz", const char* name6 = "zz")const {
	  return TSymatrix3f(GetAttributeFloat(ele, name1), GetAttributeFloat(ele, name2), GetAttributeFloat(ele, name3)
		  , GetAttributeFloat(ele, name4), GetAttributeFloat(ele, name5), GetAttributeFloat(ele, name6));
  }
  ...
  //==============================================================================
  /// Read Tsymatrix - Matthias
  //==============================================================================
  tsymatrix3f ReadElementTsymatrix3f(TiXmlNode* node, const std::string &name, const std::string &attrib, bool optional = false, double valdef = 0)const {
	  //TiXmlElement* ele = GetFirstElement(node, name, optional);
	  return(GetAttributeTsymatrix3F(GetFirstElement(node, name)));
  }
